...
export class ShapePointsMesh extends THREE.Points {
    ...
    initSize = 20) {
        super(_newShapePointsMeshGeometry(new Float32Array(initSize * 3), new Float32Array(initSize * 3), new Float32Array(initSize * 2), new Int32Array(initSize * 1), false), newShapePointsMeshMaterial() //new THREE.PointsMaterial( { color: 0xffffff, size:8, sizeAttenuation:false } )
        );
    ...
    _updateGeometry() {
        ...
        if (this._verts.length > bVerts.array.length ||
            ...
            this.geometry = _newShapePointsMeshGeometry(new Float32Array(this._verts), new Float32Array(this._color), new Float32Array(this._config), new Int32Array(this._perspective));
            this._dirty = false;
            return;
        }
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
/** @type {Int32Array} */ aPerspective, computeBounds = true) {
